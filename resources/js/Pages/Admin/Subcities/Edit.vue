        ...
        <div class="bg-white/80 backdrop-blur-lg border-b border-teal-100/50 px-6 py-6 shadow-sm">
          <div class="max-w-7xl mx-auto">
            <div class="flex justify-between items-center">
              <div>
                <h1 class="text-3xl font-bold bg-gradient-to-r from-teal-600 to-blue-600 bg-clip-text text-transparent">Edit Subcity</h1>
                <p class="text-slate-600 mt-2">Update subcity information</p>
              </div>
              <button 
                ...
                <div class="space-y-6">
                  ...
                  <div class="flex justify-end space-x-4 pt-6 border-t border-slate-200">
                    ...
                    >
                      ...
                      <span v-else>Update Subcity</span>
                    </button>
                  </div>
                </div>
              </form>
