        ...
        <div class="bg-white/80 backdrop-blur-lg border-b border-blue-100/50 px-6 py-6 shadow-sm">
          <div class="max-w-7xl mx-auto">
            <div class="flex justify-between items-center">
              <div>
                <h1 class="text-3xl font-bold bg-gradient-to-r from-blue-600 to-teal-600 bg-clip-text text-transparent">Edit City</h1>
                <p class="text-slate-600 mt-2">Update city information</p>
              </div>
              <button 
...
const submit = () => {
  form.put(`/admin/cities/${props.city.id}`, {
    preserveScroll: true,
    onSuccess: () => {
