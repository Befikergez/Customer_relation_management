<template>
  <div class="flex min-h-screen bg-gradient-to-br from-blue-50 to-teal-50">
    ...
    <div class="flex-1 flex flex-col">
      <!-- Header -->
      <div class="bg-white/90 backdrop-blur-lg border-b border-blue-200/50 shadow-sm">
              ...
              <div class="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p class="text-black/70 text-lg mt-1">
                    Manage Users, Roles, Products, Categories & Industries
                  </p>
                </div>
              </div>
            </div>
            ...
            <div class="mt-6 lg:mt-0">
              ...
              <div class="relative">
                ...
                <input
                  ...
                  class="block w-full lg:w-80 pl-12 pr-4 py-3 border border-blue-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white/80 backdrop-blur-sm shadow-sm transition-all duration-300 text-base text-black placeholder-blue-400"
                  @input="handleSearch"
                />
              </div>
            </div>
      ...
      <div class="flex-1 px-8 py-8">
        <!-- Search Results Info -->
        <div v-if="searchQuery && filteredSections.length > 0" class="max-w-6xl mx-auto mb-6">
          <p class="text-black/70 text-lg font-medium">
            Found {{ filteredSections.length }} management section{{ filteredSections.length === 1 ? '' : 's' }} matching "{{ searchQuery }}"
          </p>
        </div>
              ...
              >
                <div class="flex items-center justify-between">
                  <div class="flex items-center space-x-4">
                    ...
                    <div>
                      <h3 class="text-xl font-bold text-black mb-1">User Management</h3>
              ...
              >
                <div class="flex items-center justify-between">
                  <div class="flex items-center space-x-4">
                    ...
                    <div>
                      <h3 class="text-xl font-bold text-black mb-1">Role Management</h3>
              ...
              >
                <div class="flex items-center justify-between">
                  <div class="flex items-center space-x-4">
                    ...
                    <div>
                      <h3 class="text-xl font-bold text-black mb-1">Product Management</h3>
              ...
              >
                <div class="flex items-center justify-between">
                  <div class="flex items-center space-x-4">
                    ...
                    <div>
                      <h3 class="text-xl font-bold text-black mb-1">Category Management</h3>
              ...
              >
                <div class="flex items-center justify-between">
                  <div class="flex items-center space-x-4">
                    ...
                    <div>
                      <h3 class="text-xl font-bold text-black mb-1">Industry Management</h3>
        ...
        <div v-if="filteredSections.length === 0 && searchQuery" class="flex items-center justify-center py-20">
          <div class="text-center">
            <div class="relative">
              <div class="absolute -inset-1 bg-gradient-to-r from-blue-500 to-teal-500 rounded-2xl blur opacity-10"></div>
              <div class="relative bg-white/90 backdrop-blur-sm p-8 rounded-xl border border-blue-200/50 shadow-sm max-w-md">
                <div class="bg-gradient-to-r from-blue-100 to-teal-100 p-4 rounded-2xl inline-block mb-6">
    ...
    <!-- Modal Backdrop -->
    <div v-if="showUserModal || showRoleModal || showProductModal || showCategoryModal || showIndustryModal" 
...
const filteredSections = computed(() => {
  if (!searchQuery.value) {
    return ['users', 'roles', 'products', 'categories', 'industries']
  }
