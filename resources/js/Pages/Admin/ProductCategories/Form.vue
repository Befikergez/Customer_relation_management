<template>
  <form @submit.prevent="submit" class="bg-white rounded-2xl shadow-xl border border-blue-100 p-8 space-y-8 max-w-2xl mx-auto">
    <!-- Header -->
    <div class="text-center mb-8">
      ...
      <p class="text-slate-600 mt-3">
        {{ isEdit ? 'Modify category information' : 'Add a new product category to organize your products' }}
      </p>
    </div>
