      ...
      <div class="min-h-screen bg-gradient-to-br from-blue-50 via-white to-teal-50">
        ...
        <div class="bg-white border-b border-slate-200 px-6 py-6">
          <div class="flex justify-between items-center">
            <div>
              <h1 class="text-3xl font-bold bg-gradient-to-r from-blue-600 to-teal-600 bg-clip-text text-transparent">Edit Opportunity</h1>
              <p class="text-slate-600 mt-2">Update opportunity details</p>
            </div>
            <button 
              @click="goBack"
