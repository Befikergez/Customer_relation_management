      ...
      <div class="p-6">
        ...
        <div class="flex justify-between items-center mb-8">
          <div class="space-y-2">
            <div class="flex items-center space-x-4">
              ...
              <div>
                <h1 class="text-3xl font-bold text-slate-800">Create Proposal</h1>
                <p class="text-slate-600 text-lg">Create a new proposal for potential customers</p>
              </div>
            </div>
          </div>
          <button 
        ...
        <div class="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-blue-100 overflow-hidden">
          <div class="px-6 py-4 border-b border-blue-100 bg-gradient-to-r from-blue-50 to-teal-50">
            <h3 class="text-lg font-semibold text-slate-800">Proposal Details</h3>
          </div>
...
const submitForm = () => {
  ...
  router.post('/admin/proposals', formData, {
    onFinish: () => {
