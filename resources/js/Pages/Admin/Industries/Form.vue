<template>
  <form @submit.prevent="submit" class="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-blue-100 p-8 space-y-8 max-w-2xl mx-auto">
    <!-- Header -->
    <div class="text-center mb-8">
      <div class="w-16 h-16 bg-gradient-to-br from-blue-500 to-teal-500 rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-lg">
      ...
      <p class="text-slate-600 mt-2">
        {{ isEdit ? 'Modify industry sector information' : 'Define a new business industry category' }}
      </p>
    </div>
